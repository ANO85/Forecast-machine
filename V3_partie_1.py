...
if uploaded_file is not None:
    try:
        ...
        if not required_cols.issubset(df.columns):
            ...
            # **Suppression explicite des doublons après agrégation (si présents)**
    ...
    try:
        ...
        if not all(col in df.columns for col in expected_cols):
            ...
            for keys, group in grouped:
                ...
                # **Suppression des doublons après `set_index` pour éviter l'erreur**
                series = series[~series.index.duplicated(keep='first')]  # Supprime les doublons de l'index
